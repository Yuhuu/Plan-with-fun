...
<!--    <input type="button" value="Cancel changes" />-->
    <button type="button" data-ng-click="doCancel()" class="btn btn-default col-xs-12" style="margin-top:10px;">Clear fields</button>

    <button type="submit" class="btn btn-default col-xs-12" style="margin-top:10px;">Login</button>
    </div>
  </form>
</div>
<script>
